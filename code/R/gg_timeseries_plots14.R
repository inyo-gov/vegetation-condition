...
plot_bar_discrete <- function(PID, df, column_name, baseline_years = 1984:1987, year_min = 1984, year_max = 2024, ylab_text = "Cover (%)", fill_color = "darkgreen", baseline_label = "Baseline") {
