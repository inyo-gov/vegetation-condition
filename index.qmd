...
**Direction of trends (with statistical significance):** Control parcels show no statistically significant linear trends in cover, grass, or shrub. Wellfield parcels show statistically significant **increasing** linear trends in cover and shrub; wellfield grass shows no statistically significant trend. P-values are reported in the “Parcel Trends Over Time” section above.
