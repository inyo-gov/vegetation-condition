...
These profiles summarize observed changes for all monitored parcels (QA/QC). Potential drivers of proportional grass change include pumping‑related drawdown, climate variability, land use, or site‑specific conditions. Attribution requires integrating parcel trends with soil‑moisture and pumping management records.